...
## Project Structure
    ...
    ├── testapiautoteammemb_73313  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_73313`
...
2. Clone this repo and `cd testapiautoteammemb_73313`
